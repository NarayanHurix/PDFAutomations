...
package com.hurix.util.cssparser;
...
public final class Rule {
	...
	public Rule(final List<Selector> selectors) {
		...
		this.propertyValues = new TreeSet<PropertyValue>();
	}
	...
	public boolean equals(Object obj) {
		...
		if (propertyValues == null) {
			...
			//Collection common = CollectionUtils.union(propertyValues, other.propertyValues);
			//got same size so check it properties for equal values and property key
			//if(common.size() == propertyValues.size()){
				if(propertyValues.toString().equalsIgnoreCase(other.propertyValues.toString())){
					return true;
				}
				return false;
			//}else{
