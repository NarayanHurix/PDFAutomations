...
public class CommonFileFilter extends FileFilter implements java.io.FileFilter, java.io.FilenameFilter
{
   ...
   public CommonFileFilter(String fileType, String[] filters, String desc)
   {
      m_FileType = fileType;
